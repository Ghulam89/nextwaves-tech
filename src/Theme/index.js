...
const theme = createTheme({
    ...
    palette: {
        ...
        primary: {
            main: "#5E17EC", // Document Main Primary Color
            ...
            box_show_blog: "#5E17EC", //Box Shadow Blog Section
            box_shadow_blog_2: "#5E17EC", // Box Shadow Blog Category
            ...
            HeroGradient: "linear-gradient(to right, #FFF , #5E17EC)", // Gradient (Hero Section)
            WorkGradient: "linear-gradient(to right, #5E17EC, #FFF)", // Gradient (Portfolio Section)
            ContactGradient: "linear-gradient(to right, #5E17EC, #FFFFFF4A)", // Gradient (Contact Section)
        }
    },
    breakpoints: {
        values: {
